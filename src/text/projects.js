export const projs = {
  ...
  [
    ...
    { title:"Workforce Discrete-Event Simulation",
      ...
      description:"<b>Modelled</b> work-schedule <b>stochastically</b> for field workers in telecoms. <br/> Accerating business decisions on workforce planning",
    ...
    { title:"Data Analysis on EV-Fleet Transition",
      date:"2020",
      collaboration:"BT - Applied Research",
      description:"Helped source and build data models from <b>unstructured fleet and power data</b> accross the business. <br/> Contributed to meeting the UK's '2030 Carbon-Neutral' target  <br/>through planning the transition from using traditional fueled vehicles to electrical vehicles in the telecoms industry.",
      skills:["Data Processing", "Data Comprehension", "Data Visualisation"],
      type:'DATA'
    },
    { title:"3D Ballet Simulation Application",
      date:"2016",
      collaboration:"Final-year Project at University of East Anglia",
      description:"Created an interactive 3D Ballet Tutorial app which acts as a 'Ballet Glossary' <br/> technical terms are illustrated with a motion-capture-animated 3D rig. <br/> <a href='https://youtu.be/fEZIlpW_eFE' target='_blank'> <b>DEMO HERE</br> </a>",
    ...
    { title:"UEA Open Day Android Applications",
      ...
      description:"Android application development using Android Studio",
      skills:["Design-Patterns", "Code Re-use", "Agile Software Development"],
      type:'SOFTWARE'
    },
    ]
  };
